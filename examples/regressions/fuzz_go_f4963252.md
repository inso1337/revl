...
- Found by: `tools/fuzz_cross_tier.py` (roadmap item 292 — the empirical counterpart to item 133), seed 2, program #4.
...
FAIL
FAIL	revltest	0.591s
FAIL
```

## Minimized program (`fuzz_go_f4963252.rvl`)

```revl
pub fn probe() -> Result[Float, Str] { return Err("") }
