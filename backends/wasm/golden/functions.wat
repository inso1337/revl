...
(module
  ...
  (func $str_char_code_at (param $s i32) (param $idx i32) (result i32)
    (i32.load8_u (i32.add (i32.add (local.get $s) (i32.const 4)) (local.get $idx))))
  (func $int_div_floor (param $a i32) (param $b i32) (result i32)
    (local $q i32)
    ...
    (if (result i32)
      ...
      (else (local.get $q))))
  (func $int_div_euclid (param $a i32) (param $b i32) (result i32)
  ...
  (func $int_mod (param $a i32) (param $b i32) (result i32)
    (local $ab i32)
    (local $m i32)
    (local.set $ab
