...
(module
  ...
  (func $__canon_lift_str (param $ptr i32) (param $len i32) (result i32)
    ...
    (block (loop
      ...
      (br 0)))
    (local.get $s))
  ;; canonical export of pure fn `echo` -> WIT `echoer#echo`
  (func (export "revl:exported/echoer#echo") (param $c_p0 i32) (param $c_p0_len i32) (result i32)
    (local $c_s0 i32) (local $c_q i32) (local $c_ret i32)
    (local.set $c_s0 (call $__canon_lift_str (local.get $c_p0) (local.get $c_p0_len)))
    (local.set $c_q (call $echo (local.get $c_s0)))
    (local.set $c_ret (call $alloc (i32.const 8)))
    (i32.store (local.get $c_ret) (i32.add (local.get $c_q) (i32.const 4)))
    (i32.store offset=4 (local.get $c_ret) (i32.load (local.get $c_q)))
    (local.get $c_ret))
  ;; canonical export of pure fn `shout` -> WIT `echoer#shout`
  (func (export "revl:exported/echoer#shout") (param $c_p0 i32) (param $c_p0_len i32) (result i32)
    (local $c_s0 i32) (local $c_q i32) (local $c_ret i32)
    (local.set $c_s0 (call $__canon_lift_str (local.get $c_p0) (local.get $c_p0_len)))
    (local.set $c_q (call $shout (local.get $c_s0)))
    (local.set $c_ret (call $alloc (i32.const 8)))
    (i32.store (local.get $c_ret) (i32.add (local.get $c_q) (i32.const 4)))
    (i32.store offset=4 (local.get $c_ret) (i32.load (local.get $c_q)))
    (local.get $c_ret))
  ;; canonical export of pure fn `greet` -> WIT `echoer#greet`
  (func (export "revl:exported/echoer#greet") (param $c_p0 i32) (param $c_p0_len i32) (result i32)
    (local $c_s0 i32) (local $c_q i32) (local $c_ret i32)
    (local.set $c_s0 (call $__canon_lift_str (local.get $c_p0) (local.get $c_p0_len)))
    (local.set $c_q (call $greet (local.get $c_s0)))
    (local.set $c_ret (call $alloc (i32.const 8)))
    (i32.store (local.get $c_ret) (i32.add (local.get $c_q) (i32.const 4)))
    (i32.store offset=4 (local.get $c_ret) (i32.load (local.get $c_q)))
    (local.get $c_ret))
