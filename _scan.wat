...
(module
  ...
  (global $__hp (mut i32) (i32.const 0))
  ...
  (func (export "provide:s.f") (param $p_x i64) (result i64) (local $__revl_tmp i32)
    (call $alloc (i32.const 48))
      (local.set $__revl_tmp)
      (i32.store (local.get $__revl_tmp) (i32.const 5))
      (i64.store (i32.add (local.get $__revl_tmp) (i32.const 8)) (i64.const 3))
      (i64.store (i32.add (local.get $__revl_tmp) (i32.const 16)) (i64.const 0))
      (i64.store (i32.add (local.get $__revl_tmp) (i32.const 24)) (i64.const 5))
      (i64.store (i32.add (local.get $__revl_tmp) (i32.const 32)) (i64.const 0)
      (i64.const 1)
      (call $int_sub))
      (i64.store (i32.add (local.get $__revl_tmp) (i32.const 40)) (i64.const 9))
  ...
  (func $list_slice (param $s i32) (param $start i64) (param $end i64) (result i32)
    ...
    (local.get $p))
  (func $scan (export "scan") (param $p_xs i32) (result i64) (local $l_n i64) (local $l_v i64) (local $for_ptr_1 i32) (local $for_cnt_1 i32) (local $for_idx_1 i32) (local $__revl_tmp i32)
    (i64.const 0)
    (local.set $l_n)
    (local.get $p_xs)
    (local.set $for_ptr_1)
    (i32.load (local.get $for_ptr_1))
    (local.set $for_cnt_1)
    (i32.const 0)
    (local.set $for_idx_1)
    (block $revl_brk_1
      (loop $revl_top_1
        (i32.ge_s (local.get $for_idx_1) (local.get $for_cnt_1))
        (br_if $revl_brk_1)
        (i64.load (i32.add (local.get $for_ptr_1) (i32.add (i32.const 8) (i32.mul (local.get $for_idx_1) (i32.const 8)))))
        (local.set $l_v)
        (block $revl_cnt_1
          (local.get $l_v)
      (i64.const 0)
      ...
      (call $int_add)
        ...
        (local.set $for_idx_1 (i32.add (local.get $for_idx_1) (i32.const 1)))
        (br $revl_top_1)
      )
    )
    (local.get $l_n)
