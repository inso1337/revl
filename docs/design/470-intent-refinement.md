...
Stage 1 is recorded as closed below rather than deleted, because section 3.6 is
the slice that closed it and the stage text is what that slice was measured
against.
