...
41. 🚧 **The Component Model bridge — slices 1-2 ✅; slice-3 Str-canonical ABI ✅ (cabi_realloc + string lift/lower + wit-component, wasmtime component-model proven, fb81e79); aggregate (records/lists/variants) + service canonical lowering remain
