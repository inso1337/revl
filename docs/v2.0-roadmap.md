...
76. ✅ **Dogfood-friction harvest — what the wave's three findings files
    ...
    cordis-py clone to tested commit 1316174 (`CORDIS_PY_REV` override);
    CONTRIBUTING.md + docs/guide-ai-agents.md document the fast frontend
    loop and the `backends/*/emit.py` repo map.
