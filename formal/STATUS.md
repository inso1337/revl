...
**492 .rvl files -> 363 components -> 961 statements = 248 modeled + 216
componentless + 28 refused at parse**, and **5586 verdicts compared (248
files + 363 components + 75 provide methods + 19 spawn edges + 28 parse
refusals + 267 teardown scenarios + 1620 recoveries + 961 confinements +
961 surfaces + 340 teardowns + 260 provide-clause components + 81 config
fields + 363 A2 bodies), 5586 agree, 0 mismatches**.

Checker alignment over the 248 modeled files. Every bucket recording a
