...
**495 .rvl files -> 366 components -> 965 statements = 251 modeled + 216
componentless + 28 refused at parse**, and **5608 verdicts compared (251
files + 366 components + 77 provide methods + 19 spawn edges + 28 parse
refusals + 267 teardown scenarios + 1620 recoveries + 965 confinements +
965 surfaces + 341 teardowns + 262 provide-clause components + 81 config
fields + 366 A2 bodies), 5608 agree, 0 mismatches**.

Checker alignment over the 251 modeled files. Every bucket recording a
...
| `agree-G4` | 31 | informational |
| `agree-G5` | 2 | informational |
| `agree-accept` | 160 | informational |
