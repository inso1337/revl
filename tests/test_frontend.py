...
REJECTIONS = {
    ...
    "v2_duplicate_let_block_scope.rvl": "lets are function-scoped, not block-scoped",
    ...
    "g4_extern_undo_param_not_in_scope.rvl": "`path` is not declared — the `undo` slot of extern `open_ledger` runs with no variables in scope",
