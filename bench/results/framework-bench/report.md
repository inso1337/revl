...
**11 of 261 corpus documents (n=261) that the reference compiler accepts are not reproduced by the fully-native chain.**
...
|---|---|---|---|
| **refused** | 0 (TypeScript compiles everything) | not run (`@modelcontextprotocol/sdk` 1.30.0 named, harness not built) | **11 / 261** |
...
| claim | rung |
|---|---|
| the fully-native revl chain does not reproduce 11 of 261 corpus documents that the reference compiler accepts (n=261) | measured |
